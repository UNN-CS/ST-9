...
namespace HotelCalculator
{
    ...
    {
        private const int EconomyRate = 950;
        private const int StandardRate = 1850;
        private const int LuxuryRate = 2800;
        private const int TwoBedSurcharge = 400;
        private const int ThreeBedSurcharge = 850;
        private const int SafeCost = 250;
        private const int BreakfastCost = 270;
