...
namespace TestProject1
{
    ...
    public class HotelCalculatorTests
    {
        ...
        [TestMethod]
        public void CalculatePrice_EconomySingleRoom_NoExtras_5Days_CorrectTotal()
        {
            // Arrange
            EnterDays("5");
        ...
        [TestMethod]
        public void CalculatePrice_StandardDoubleRoom_WithBreakfast_3Days_CorrectTotal()
        {
            // Arrange
            EnterDays("3");
        ...
        [TestMethod]
        public void CalculatePrice_LuxuryTripleRoom_AllExtras_2Days_CorrectTotal()
        {
            // Arrange
            EnterDays("2");
        ...
        [TestMethod]
        public void CalculatePrice_EconomySingleRoom_WithSafe_1Day_CorrectTotal()
        {
            // Arrange
            EnterDays("1");
            SelectCategory("1 - Эконом");
        ...
        [TestMethod]
        public void CalculatePrice_EconomySingleRoom_WithSafe_3Days_CorrectTotal()
        {
            // Arrange
            EnterDays("3");
            SelectCategory("1 - Эконом");
